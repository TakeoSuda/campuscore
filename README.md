...
![CampusCore Dashboard](./public/images/campuscore_main_image.png)
![CampusCore Dashboard](./public/images/campuscore_login_image.png)
...
**管理者ページ**
**アンケート入力、保存機能**
**自由英作文添削機能（AI添削+人間の講師による添削のダブルフィードバック）**
**英文和訳添削機能（AI添削+人間の講師による添削のダブルフィードバック）**
**面談記録機能**
**勉強日記機能**：利用者（生徒）による勉強日記の入力作成。
**勉強計画記録機能**：利用者（生徒）による勉強計画の入力作成。
**ユーザーへの学習アドバイス送信機能**
**模試結果入力、保存機能**
**英文法テスト機能**
**英文法テスト結果保存機能**
**パスナビからの志望校情報スクレイピング機能**
